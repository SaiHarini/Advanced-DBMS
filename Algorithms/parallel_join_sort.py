...
SORT_COLUMN_NAME_FIRST_TABLE = 'column11'
# SORT_COLUMN_NAME_SECOND_TABLE = 'column2'
JOIN_COLUMN_NAME_FIRST_TABLE = 'column11'
JOIN_COLUMN_NAME_SECOND_TABLE = 'column21'
##########################################################################################################
...
def ParallelJoin (InputTable1, InputTable2, Table1JoinColumn, Table2JoinColumn, OutputTable, openconnection):
    ...
    print("wait to finish all threads")
    for i in range(TOTAL_THREADS):
        threadspool[i].join()
...
if __name__ == '__main__':
	...
	print("Saving parallelSortOutputTable and parallelJoinOutputTable on two files")
